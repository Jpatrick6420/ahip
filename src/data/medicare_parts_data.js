const questions = [
  ...
  },
  {
    id: "2.8.24",
    question:
      "Mrs. Lyon is in good health, uses a single perscription and lives independently in her own home. She is attracted to the idea of manageing her own savings account (MSA) but is unsure if the plan managing the account will fit her needs. What can you tell her?",
    answer:
      "Funds are contributed by the medicare program to her MSA. They are not paid on a pretax basis. The enrollee must continue to pay the part B premium and the plan will start to pay once the enrollee has reached their deductable. The enrollee has the option to use funds prior to hitting the deducable. Once the deducatble is reached, the plan pays 100%.",
  },
  ...
  },
  {
    ...
    answer:
      "If part D is offered through her plan then she may choose to enroll into that plan or she can choose a PDP",
  },
  {
    id: "3.4.24",
    question:
